...
class JpaRepositoryTest {
    ...
    void givenTestData_whenInserting_thenWorksFine() {
        ...
        UserAccount userAccount = userAccountRepository.save(UserAccount.of("newYjj","pw",null,null,null));
    ...
    void givenParentCommentId_whenSelecting_thenReturnsChildComments() {
        ...
        // Then
        assertThat(parentComment).get() //null check
                .hasFieldOrPropertyWithValue("parentCommentId", null) //필드값 체크
                .extracting("childComments", InstanceOfAssertFactories.COLLECTION) //추출, 타입 체크
                        .hasSize(4); //사이즈 체크
    }

    @DisplayName("댓글에 대댓글 삽입 테스트")
    @Test
    void givenParentComment_whenSaving_thenInsertChildComment() {
        // Given
    ...
    void givenArticleCommentIdHavingChildCommentsAndUserId_whenDeletingParentComment_thenDeletesEveryComment() {
        ...
        // When
        articleCommentRepository.deleteByIdAndUserAccount_UserId(1L,"yjj");
